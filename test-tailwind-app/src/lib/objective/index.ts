...
import { scoreExBody } from './exbody';   // Only import what exists
...
/* ──────────────────────────────────────────────────────────────
   ...
   ].forEach((k: string) => { if (combinedRadar[k] === undefined) combinedRadar[k] = 10; });
 ...
 > = {
   ...
   // exbody   : { label: 'ExBody',   form: exbody.FORM   }, // Removed, not exported
