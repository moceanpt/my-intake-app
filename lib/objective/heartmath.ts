...
export const heartmathMetricSchema: MetricSchema = {
  ...
  groups: [
    {
      section: 'basic',
      title: 'Basic HRV Metrics',
      fields: [
        { name: 'heartmath_basic', label: 'Basic HRV Metrics', widget: 'heartmath-table' as const, tableType: 'basic' },
      ]
    },
    {
      section: 'spectrum',
      title: 'Power Spectrum & Coherence',
      fields: [
        { name: 'heartmath_spectrum', label: 'Power Spectrum & Coherence', widget: 'heartmath-table' as const, tableType: 'spectrum' },
      ]
    }
  ]
};
