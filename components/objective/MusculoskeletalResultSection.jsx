                  ...
                  <div style={{ 
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '0.75rem' }}>
                      {block.metrics.map((metric) => {
                        ...
                        const metricColor = getMetricColor(metric.key, value, score);
