...
function getAuraComInputColor(value, metricName) {
...
const AuraComTableWithCorrection = ({ fields, aiExtractedData = {} }) => {
    ...
    <div style={{ marginBottom: '1.5rem', maxWidth: '600px' }}>
      ...
      {hasAIExtractedData && (
        <div style={{ marginBottom: '1rem' }}>
          ...
          >
            {isEditing ? 'Done Editing' : 'Edit AuraCom Values'}
          </button>
        </div>
      )}
...
export default AuraComTableWithCorrection;